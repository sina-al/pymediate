...
class NotificationHandlerBaseMixin[NotificationT]:
    ...
    def __init_subclass__(cls, **kwargs: Any) -> None:
        ...
        defined. It extracts the notification type from NotificationHandler[EventType],
        ...
        # Extract notification type from NotificationHandler[EventType]; find the base whose
