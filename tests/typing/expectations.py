...
EXPECTED_MYPY_CODES: dict[str, set[str]] = {
    ...
    "event_handler_non_event_type_argument": {"type-var"},
...
EXPECTED_BASEDPYRIGHT_RULES: dict[str, set[str]] = {
    ...
    "event_handler_non_event_type_argument": {"reportInvalidTypeArguments"},
    ...
    "publish_non_event": {"reportArgumentType"},
