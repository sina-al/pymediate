...
def clear_registries() -> Generator[None]:
    ...
    from handler registrations. RequestHandler classes should be defined within test
    ...
    Note:
        ...
        - RequestHandler classes should be defined inside test functions for proper cleanup
    """
    yield
