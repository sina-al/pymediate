...
{/* pmd-note: CountOrder and CountResult are named by the prose, not defined. */}
...
{/* pmd-note: RefundOrder and PaymentRefunds are named by the prose, not defined. */}
...
{/* pmd-note: RefundOrder, RefundResult and RefundPayment likewise. */}
