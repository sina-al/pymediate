...
| --- | --- | --- |
| Import | `from pymediate import RequestHandler, Mediator` | `from pymediate.aio import RequestHandler, Mediator` |
| RequestHandler method | `def __call__(self, request)` | `async def __call__(self, request)` |
...
```python
from pymediate import Request, RequestHandler as SyncHandler, Mediator as SyncMediator
