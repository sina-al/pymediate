...
<Tabs items={['Async', 'Sync']}>
  <Tab value="Async">
    ...
    from pymediate import Event, PipelineBehavior, Request, ServiceProvider, StreamRequest
  ...
  <Tab value="Sync">
    ...
    from pymediate.sync import Event, PipelineBehavior, Request, ServiceProvider, StreamRequest
