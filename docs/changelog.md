...
This page mirrors the [CHANGELOG.md](https://github.com/sina-al/pymediate/blob/main/CHANGELOG.md) at the repository root, which is generated from Conventional Commits with [git-cliff](https://git-cliff.org/) on each release. Do not hand-edit the content below — regenerate it from the root file after each release instead.
