...
The roadmap lives in [GitHub Issues](https://github.com/sina-al/pymediate/issues), not in
this file:
...
- [`process`](https://github.com/sina-al/pymediate/issues?q=is%3Aissue+is%3Aopen+label%3Aprocess)
  — repo automation and workflow improvements.

Version impact of each item follows the ZeroVer policy in `OPERATIONS.md`; anything
touching public API shape gets an ADR first (`/adr` skill). File new ideas as issues with
the appropriate label — don't grow lists here.
