"""Tests for the FastAPI adapter — exercises the whole core over ASGI with httpx."""
...
async def test_add_task_returns_201_with_created_task(client: httpx.AsyncClient) -> None:
...
async def test_ids_increment(client: httpx.AsyncClient) -> None:
...
async def test_complete_task_marks_done(client: httpx.AsyncClient) -> None:
...
async def test_complete_unknown_task_returns_404(client: httpx.AsyncClient) -> None:
...
async def test_list_open_tasks_excludes_done(client: httpx.AsyncClient) -> None:
...
async def test_each_app_gets_its_own_store(client: httpx.AsyncClient) -> None:
