...
Holds the mediator and wiring lifecycle shared by subcommands. It provides the interface used
...
The root workspace extra `cli` installs this host alongside the selected infrastructure profile.
...
The [complete Shop guide](../../README.md) describes profile selection and process-local limits.
