...
class OutboxAppended(Notification):
    ...
    worker also polls. Drop this notification entirely and the read side still catches up on
    the next poll. It carries the new sequence purely so a subscriber could log how far behind
    it is.
    """
