...
This is the synchronous mirror of ``examples/060-messages/messages.py`` — the request
dataclasses are identical; only the ``Request`` import differs (``pymediate.sync``).
"""
