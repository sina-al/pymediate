...
import pytest
from pymediate.sync import HandlerAlreadyRegisteredError, RequestHandler
...
def test_the_fix_is_varying_the_constructor_not_the_class() -> None:
