...
compose handlers through the mediator; 15–16 make the framework-independence argument; 17
plugs it into a DI container. Async and sync examples mirror each other deliberately —
