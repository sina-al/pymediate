...
This example applies the same rate limit with a method decorator and with a synchronous
...
class RateLimitBehavior(PipelineBehavior[AddTask]):
    ...
    def __call__(self, request: AddTask, next: Next[Task]) -> Task:
...
- [050-handler-composition-sync](../050-handler-composition-sync/) composes several operations
  through a synchronous mediator.
- [045-behaviors-vs-decorators](../045-behaviors-vs-decorators/) shows the asynchronous API.
