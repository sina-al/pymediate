...
storage and SQS message delivery. Switching to this package changes infrastructure without changing
...
bindings, FastAPI, CLI, or worker implementation.
...
five-attempt move to a DLQ, and completion from that queue. Storage is exercised against MinIO
